...
from tests import LAM_HELLO_WORLD_HTML, LAM_PROPERTIES_JSON, LAM_CLASSES_JSON, CELEX_CLASSES_JSON, LAM_PROPERTIES_HTML, \
    LAM_CLASSES_HTML
...
class MyTestCase(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        with LAM_CLASSES_JSON.open("r") as property_file:

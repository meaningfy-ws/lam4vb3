...
from lam2doc import rdf2json, LAM_PROPERTIES_JSON, LAM_CLASSES_JSON, CELEX_CLASSES_JSON
from lam4vb3 import THIS_PROJECT, LAM_PROPERTIES_TTL, CELEX_CLASSES_TTL, LAM_CLASSES_TTL

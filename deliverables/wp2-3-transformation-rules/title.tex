...
% First Page
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\DelTitle}{The transformation rules from LAM-SKOS-AP representation into OWL representation}
\newcommand{\DelNumber}{WP 2.3}
\newcommand{\DelVersion}{1.0}
\newcommand{\DelAuthor}{Eugeniu Costetchi}
\newcommand{\DelDate}{16 December 2019}
\newcommand{\DelFilename}{wp2-4-transformation-rules}

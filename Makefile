...
upload-to-fuseki-meaningfy-ws:
	...
	@ curl -X POST -H content-type:text/turtle -T data/lam_project_properties_v2.ttl -G 'http://dev.meaningfy.ws:3030/lam/data' --data-urlencode 'graph=http://publications.europa.eu/resources/authority/lam/DocumentProperty'

...
# TODO: why it does not return all annotations?
...
def test_lam_classes_property_configuration_SG_query(lam_classes_property_configuration_MI_query, lam_classes_graph):
